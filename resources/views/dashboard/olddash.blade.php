    ...
    var myChart1 = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#5A1212', '#1A2124','#614B52'], // Set the background color for the dataset
            }]
        },
        options: {
            title: {
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [<?php echo $users; ?>,], // Set the data for the dataset
                backgroundColor: ['#344C64', ], // Set the background color for the dataset
            }]
        },
    ...
    var myChart2 = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#345F64' ], // Set the background color for the dataset
            }]
        },
        options: {
            title: {
    ...
    var myChart3 = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#344C64','#5D0E41','#78A083','#DA0C81' ], // Set the background color for the dataset
            }]
        },
        options: {
            title: {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [ @foreach ($purposals as $purposal1)
                        ...
                        @endforeach], // Set the data for the dataset
                backgroundColor: ['#082032' ], // Set the background color for the dataset
            }]
        },
              ...
              <div class="card-body p-4">
                <div class="row">
                  <div class="col-8">
                    ...
                    <h4 class="card-subtitle text-body-secondary m-0">{{$users}}</h4>
                  </div>
